(async function () {
     ...
     *
     * ESM targets (body[data-module="true"], e.g. the rail-shooter) are injected
     * as type="module" so their bare imports ("three", "pewpew") resolve via the
     * page importmap. Note: a module's failed sub-imports surface as console
     * errors, not script.onerror — onerror only covers the top-level fetch.
     */
    function startGame(gameName) {
        const script = document.createElement('script');
        if (document.body.dataset.module === 'true') script.type = 'module';
