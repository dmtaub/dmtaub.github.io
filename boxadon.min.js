...
if(i){i(s*this.tileSize,e*this.tileSize)}}}return{wallData:e,platformData:t,spikeData:s,enemyData:i,itemData:o}}createWall(e,t){return{x:e+this.tileSize/2,y:t+this.tileSize/2,width:this.tileSize,height:this.tileSize,color:9127187}}createPlatform(e,t){return{x:e+this.tileSize/2,y:t+this.tileSize/2,width:this.tileSize,height:this.tileSize/2,color:8388736}}createSpike(e,t){return{x:e+this.tileSize/2,y:t+this.tileSize/2,width:this.tileSize,height:this.tileSize,tines:this.spikeTines,color:8421504}}createEnemy(e,t,s){return{x:e+this.tileSize/2,y:t+this.tileSize/2,type:s}}createItem(e,t,s){return{x:e+this.tileSize/2,y:t+this.tileSize/2,type:s}}}let p=0
class u{constructor(e,t,s,i){this.scene=e,this.player=s,this.level=i,this.debugInputs={}
...
console.log(`[Enemy #${t}] Setting ${s} from "${o}" to "${i}"`),this.props[s]=i}))})),s}removeDebugContent(){this.debugInputs={}}}class y{constructor(e,t,s){this.scene=e,this.player=s,this.type=t.type,this.x=t.x,this.y=t.y,"h"===this.type?(this.healthAmount=1,this.color=65280,this.size=16):"H"===this.type&&(this.healthAmount=2,this.color=32768,this.size=24),this.createSprite(),e.physics.add.overlap(this.sprite,s.sprite,this.collectItem,null,this),this.sprite.setData("instance",this)}createSprite(){this.sprite=this.scene.add.circle(this.x,this.y,this.size/2,this.color)}collectItem(e,t){this.player.addHealth(this.healthAmount),e.destroy()}}const m=220
class g{constructor(e,t,s={}){this.scene=e,this.kinematics=t,this.levelOptions=s,this.walls=e.physics.add.staticGroup(),this.platforms=e.physics.add.staticGroup(),this.spikes=e.physics.add.staticGroup(),this.stars=e.physics.add.group(),this.enemies=e.physics.add.group(),this.items=e.physics.add.staticGroup(),this.inventory=new c
const i=new Date
this.initLevelData()
const o=new Date
console.log(`Level data init time: ${o-i}ms`),this.createEnemies(),this.createItems(),this.createWalls(),this.createPlatforms(),this.createSpikes()}initLevelData(){if(this.levelOptions.asciiMap){const e=new d(this.levelOptions.asciiMap,{spikeTines:this.levelOptions.spikeTines||1,repeatCount:this.levelOptions.sideScroll||0}),{wallData:t,platformData:s,spikeData:i,enemyData:o,itemData:n}=e.parse(),{width:r,height:a}=e.getLevelDimensions()
this.scene.cameras.main.setBounds(0,-220,r,a+m),this.scene.cameras.main.startFollow(this.scene.player.sprite),this.scene.physics.world.setBounds(0,-220,r,a+m),this.wallData=t,this.platformData=s,this.spikeData=i,this.enemyData=o,this.itemData=n}else this.wallData=[{x:400,y:568,width:800,height:64,color:2263842,name:"ground"},{x:600,y:400,width:150,height:32,color:9127187},{x:50,y:250,width:150,height:32,color:9127187},{x:750,y:220,width:150,height:32,color:9127187}],this.platformData=[{x:400,y:350,width:200,height:16,color:8388736}],this.spikeData=[{x:775,y:522,width:60,height:28,tines:15,color:8421504},{x:25,y:522,width:50,height:28,tines:15,color:8421504}],this.itemData=[],this.enemyData=[]}createEnemies(){this.enemyData.forEach((e=>{const t=new u(this.scene,e,this.scene.player,this)
...
this.scene.events.on("update",(()=>{n+=r,e.x=t+o*Math.cos(n),e.y=i+o*Math.sin(n)}))}collectStar(e,t){t.destroy(),this.player.score+=10,0===this.stars.countActive(!0)&&this.scene.levelComplete()}}class v extends g{constructor(e,t,s,i,o=1,n){super(e,t),this.player=n,this.difficultySettings=s,this.levelNumber=i,this.levelIndexInType=o
...
this.scene.physics.add.existing(i),this.stars.add(i),i.body.setBounce(this.elasticity),i.body.setCollideWorldBounds(!0),i.body.setVelocity(s.Math.Between(-200,200),s.Math.Between(-200,200))}}createWinCondition(){this.winObject=this.scene.add.triangle(400,50,0,60,60,60,30,0,16776960),this.scene.physics.add.existing(this.winObject),this.winObject.body.allowGravity=!1,this.winObject.body.setCollideWorldBounds(!0),this.winObject.body.setImmovable(!0),this.winObject.body.setVelocityX(100),this.winObject.body.setBounce(1,0),this.scene.physics.add.overlap(this.winObject,this.player.sprite,(()=>{this.scene.levelComplete()}))}update(){}}class x{constructor(e,t){this.player=e,this.kinematics=t,this._totalWeight=this.player.inventory.totalWeight,this.baseSpeed=160,this.baseJumpSpeed=this.kinematics.jumpSpeed,this.updateMovementFactors()}get totalWeight(){return this._totalWeight}set totalWeight(e){this._totalWeight!==e&&(this._totalWeight=e,this.updateMovementFactors())}updateMovementFactors(){let e=1-this.totalWeight*this.kinematics.weightSlowFactor
...
this.totalWeight=e}}class S{constructor(e,t,s,i,o){this.scene=e,this.x=t,this.y=s,this.direction=i,this.type=o,this.sprite=e.physics.add.image(this.x,this.y,this.type.textureKey),this.sprite.setScale(1),this.sprite.body.allowGravity=!1,this.sprite.body.setCollideWorldBounds(!1)}init(){let e=this.type.speed
"left"===this.direction?this.sprite.setVelocityX(-e):this.sprite.setVelocityX(e),this.scene.time.delayedCall(1e3,(()=>{this.sprite.destroy()}))}}class I{static defaultMaxHearts=4
constructor(e,t=100,s=450,i={},o,n,r){this.scene=e,this.x=t,this.y=s,this.kinematics=o,this.projectileType=n,this.difficultySettings=r,this.color=void 0===i.playerColor?16711680:i.playerColor,this.maxHearts=i.maxHearts||I.defaultMaxHearts,this.hearts=this.maxHearts,this.recoilTimer=400,this.invulnerable=!1,this.inventory=new c,this.score=0,this.sprite=e.add.rectangle(this.x,this.y,32,48,this.color),e.physics.add.existing(this.sprite),this.sprite.body.setCollideWorldBounds(!0),this.sprite.body.setGravityY(this.kinematics.gravityY),this.facing="right",this.lastFired=0,this.isJumping=!1,this.jumpTime=0,this.movementFactors=new x(this,this.kinematics),this.projectiles=e.physics.add.group(),this.heartsGroup=e.add.group(),this.createHeartsDisplay(),this.scoreText=e.add.text(20,50,"Score: 0",{fontSize:"16px",fill:"#000"}),this.currentUIScrollFactor=0,this.setUIScrollFactor(0)}setUIScrollFactor(e=0){this.currentUIScrollFactor=e,this.scoreText.setScrollFactor(e),this.heartsGroup.children.each((t=>{t.setScrollFactor(e)}))}createHeartsDisplay(){this.heartsGroup.clear(!0,!0)
const e=16711680
let t,s,i
...
this.flashTween=this.scene.tweens.add({targets:e,duration:this.recoilTimer/t/2-10,alpha:.25,ease:"Linear",yoyo:!0,repeat:t-1,onComplete:()=>{e.alpha=1,this.flashTween=null}})}this.hearts<=0&&this.scene.scene.start("GameOverScene")}}_damageRecoil(e,t,i){const o=new s.Math.Vector2(e.x-t.x,-Math.abs(e.y-t.y)).normalize(),n=i/this.maxHearts*I.defaultMaxHearts*200,r=i/this.maxHearts*I.defaultMaxHearts*100
e.useVelocity?(e.body.touching.left?e.body.velocity.x=n:e.body.touching.right&&(e.body.velocity.x=-n),e.body.velocity.y=-r):(e.body.velocity.x=o.x*n,e.body.velocity.y=o.y*r)}destroy(){this.sprite.destroy(),this.projectiles.clear(!0,!0),this.heartsGroup.clear(!0,!0),this.scoreText.destroy()}}const k=(e,t)=>{if(e===t)return
...
class C{myId=void 0
container=void 0
constructor(e="Floating Window From Class ",t=document.createElement("div"),s={width:200,height:200,top:50,left:50},i=k){if(this.title=e,this.contentElement=t,this.startDimensions=s,this.onTitleChange=i,this.myId=e.toLowerCase().replace(/\s/g,"-"),i&&(i(this.myId,this.myId),t&&(t.id=this.myId)),document.getElementById(this.myId))throw new Error(`Element with ID '${this.myId}' already exists!`)
...
class T extends s.Scene{constructor(){super({key:"MainScene"}),this.debugMode=!1,this.isPaused=!1}init(e){this.currentLevel=e.level||1,this.gameMode=e.gameMode||"easy",this.game.registry.set("gameMode",this.gameMode),this.events.on("shutdown",(()=>{this.debugGraphics&&(this.debugGraphics.clear(),this.debugGraphics.destroy(),this.debugGraphics=null)}))}preload(){}create(){this.cameras.main.setBackgroundColor("#87CEEB"),this.difficultySettings=new a,this.kinematics=new h(this.currentLevel),this.projectileType=new l(this,{size:{width:10,height:10},shape:"triangle",speed:500,color:16776960,cooldown:200,recoilForce:100})
let e=this.game.registry.get("playerColor")
if(e=void 0===e?16711680:e,this.player=new I(this,100,450,{maxHearts:4,playerColor:e},this.kinematics,this.projectileType,this.difficultySettings),this.inputManager=new r(this),this.levelProgression=this.difficultySettings.game.getProgression(this.gameMode),this.currentLevel<=this.levelProgression.length){{const e=this.levelProgression[this.currentLevel-1]
let t
switch(e.levelType){case"StarLevel":default:t=b
break
case"FloatingStarLevel":t=f
break
case"BallLevel":t=v}const s=e.levelIndexInType
...
this.floatingWindow||=new C(n,o,{width:640,height:350,top:s,left:i},null),this.floatingWindow.container.parentElement&&this.floatingWindow.container.remove(),this.floatingWindow.recreate(s,i,o,n),o.addEventListener("keydown",(e=>{e.stopPropagation()}))
