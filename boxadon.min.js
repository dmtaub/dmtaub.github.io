...
for(let h=0;h<t.tines;h++){let a=t.x-e/2+h*i+i/2+s,o=t.y+t.height/2,r=this.scene.add.triangle(a,o,-i/2,t.height/2,0,-t.height/2,i/2,t.height/2,t.color)
this.scene.physics.add.existing(r,!0),this.spikes.add(r),r.body.setOffset(-s,0)}}))}update(t,e){this.enemies.children.iterate((i=>{const s=i.getData("instance")
...
constructor(t,e,i,s,h=1,a){super(t,e,{asciiMap:localStorage.level1?JSON.parse(localStorage.level1).trim().split("\n"):g,spikeTines:3}),this.difficultySettings=i,this.levelNumber=s,this.levelIndexInType=h
const o=this.difficultySettings.getStarLevelOptions(h)
this.starIncreasePerLevel=o.starIncreasePerLevel,this.starFactor=w.defaultStarFactor+(this.levelIndexInType-1)*this.starIncreasePerLevel,this.createStars(),t.physics.add.collider(this.stars,this.walls,this.starWallCollision,null,this),t.physics.add.collider(this.stars,this.platforms),t.physics.add.collider(this.stars,this.spikes),t.physics.add.collider(this.stars,this.stars),this.scene.physics.add.overlap(this.stars,a.sprite,this.collectStar,null,this),this.player=a}createStars(){let t=this.starFactor
...
this.scene.tweens.add({targets:t,y:t.y+e,yoyo:!0,repeat:-1,ease:"Sine.easeInOut",duration:s})}addRotateAnimation(t){let e=t.x,s=t.y,h=i.Math.Between(20,50),a=0,o=i.Math.FloatBetween(.01,.03)
this.scene.events.on("update",(()=>{a+=o,t.x=e+h*Math.cos(a),t.y=s+h*Math.sin(a)}))}collectStar(t,e){e.destroy(),this.player.score+=10,0===this.stars.countActive(!0)&&this.scene.levelComplete()}}class x extends m{constructor(t,e,i,s,h=1,a){super(t,e),this.player=a,this.difficultySettings=i,this.levelNumber=s,this.levelIndexInType=h
const o=this.difficultySettings.getBallLevelOptions(h)
this.numberOfBalls=o.numberOfBalls,this.elasticity=o.elasticity,this.createBalls(),this.createWinCondition(),t.physics.add.collider(this.stars,this.walls),t.physics.add.collider(this.stars,this.platforms),t.physics.add.collider(this.stars,this.spikes),t.physics.add.collider(this.stars,this.stars),t.physics.add.collider(this.stars,a.sprite)}createBalls(){for(let t=0;t<this.numberOfBalls;t++){let t=i.Math.Between(50,750),e=i.Math.Between(50,300),s=this.scene.add.circle(t,e,10,255)
this.scene.physics.add.existing(s),this.stars.add(s),s.body.setBounce(this.elasticity),s.body.setCollideWorldBounds(!0),s.body.setVelocity(i.Math.Between(-200,200),i.Math.Between(-200,200))}}createWinCondition(){this.winObject=this.scene.add.triangle(400,50,0,60,60,60,30,0,16776960),this.scene.physics.add.existing(this.winObject),this.winObject.body.allowGravity=!1,this.winObject.body.setCollideWorldBounds(!0),this.winObject.body.setImmovable(!0),this.winObject.body.setVelocityX(100),this.winObject.body.setBounce(1,0),this.scene.physics.add.overlap(this.winObject,this.player.sprite,(()=>{this.scene.levelComplete()}))}update(){}}class S{constructor(t,e){this.player=t,this.kinematics=e,this._totalWeight=this.player.inventory.totalWeight,this.baseSpeed=160,this.baseJumpSpeed=this.kinematics.jumpSpeed,this.updateMovementFactors()}get totalWeight(){return this._totalWeight}set totalWeight(t){this._totalWeight!==t&&(this._totalWeight=t,this.updateMovementFactors())}updateMovementFactors(){let t=1-this.totalWeight*this.kinematics.weightSlowFactor
...
constructor(t,e=100,i=450,s={},h,a,o){this.scene=t,this.x=e,this.y=i,this.kinematics=h,this.projectileType=a,this.difficultySettings=o,this.color=void 0===s.playerColor?16711680:s.playerColor,this.maxHearts=s.maxHearts||b.defaultMaxHearts,this.hearts=this.maxHearts,this.recoilTimer=400,this.invulnerable=!1,this.inventory=new d,this.score=0,this.sprite=t.add.rectangle(this.x,this.y,32,48,this.color),t.physics.add.existing(this.sprite),this.sprite.body.setCollideWorldBounds(!0),this.sprite.body.setGravityY(this.kinematics.gravityY),this.facing="right",this.lastFired=0,this.isJumping=!1,this.jumpTime=0,this.movementFactors=new S(this,this.kinematics),this.projectiles=t.physics.add.group(),this.heartsGroup=t.add.group(),this.createHeartsDisplay(),this.scoreText=t.add.text(20,50,"Score: 0",{fontSize:"16px",fill:"#000"}),this.scoreText.setScrollFactor(0)}createHeartsDisplay(){this.heartsGroup.clear(!0,!0)
...
this.heartsGroup.add(t)}else{let e=8421504,o=this.scene.add.rectangle(h,a,i,i,e)
if(this.heartsGroup.add(o),t<this.hearts){let t=this.scene.add.rectangle(h-i/4,a,i/2,i,s)
...
break
case"BallLevel":e=x}const i=t.levelIndexInType
